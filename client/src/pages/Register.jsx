...
export default function Register() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-[radial-gradient(circle_at_top,_rgba(46,49,146,0.18),_transparent_45%),linear-gradient(135deg,#f8f9ff_0%,#e5eeff_100%)] font-body-md text-on-background">
      <main className="flex flex-grow items-center justify-center p-gutter">
        <div className="w-full max-w-md">
          <div className="mb-10 text-center">
            <div className="mb-4 inline-flex h-14 w-14 items-center justify-center rounded-3xl bg-primary text-white shadow-lg">
              <span className="material-symbols-outlined">task_alt</span>
            </div>
            <h1 className="mb-2 font-h1 text-h1 text-primary">TaskFlow</h1>
            <p className="font-body-lg text-body-lg text-on-surface-variant">Create your workspace account.</p>
          </div>
          <div className="overflow-hidden rounded-3xl border border-outline-variant bg-white/95 p-10 shadow-2xl backdrop-blur-xl">
            <h2 className="mb-6 font-h2 text-h2 text-on-surface">Create account</h2>
